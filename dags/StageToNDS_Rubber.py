...
] >> StageToNDS_ChargingStation >> [StageToNDS_Region, StageToNDS_SensorControlSystem, StageToNDS_ChargingStatus, StageToNDS_Task
] >> StageToNDS_Energy >>[ StageToNDS_Address, StageToNDS_Field] >> StageToNDS_Drone >> [ StageToNDS_UserInfo, StageToNDS_RubberTree, StageToNDS_PlanDetail
] >> StageToNDS_DroneInformation >> [ StageToNDS_RubberTreeInformation, StageToNDS_RobotTapping] >> StageToNDS_DroneImage >> [StageToNDS_Blade, StageToNDS_Environment]
